...
public class ClaudeSession {
    ...
    public ClaudeSession(Project project, ClaudeSDKBridge claudeSDKBridge, CodexSDKBridge codexSDKBridge) {
        this(project, claudeSDKBridge, codexSDKBridge, new GeminiSDKBridge());
    }
    ...
    public ClaudeSession(Project project, ClaudeSDKBridge claudeSDKBridge, CodexSDKBridge codexSDKBridge,
        ...
        this.providerRouter = new SessionProviderRouter(claudeSDKBridge, codexSDKBridge, this.geminiSDKBridge);
