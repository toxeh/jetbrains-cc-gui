...
public class PathUtilsUnsafeCwdTest {
    ...
    public void rejectsAiBridgePath() {
        assertTrue(PathUtils.isUnsafeWorkingDirectory("/Volumes/dx/dev/_home/jetbrains-cc-gui/ai-bridge"));
    }

    @Test
    public void acceptsNormalProject() {
        assertFalse(PathUtils.isUnsafeWorkingDirectory("/Volumes/dx/dev/_home/SoueastS06"));
